<template>
    <ion-page>
        ...
        <ion-content :fullscreen="true">
            ...
            <div v-if="!loading">
                <ion-card class="card card-details" :style="{backgroundColor: theme.primaryColor}">
                    <h4 class="card-title" :style="{color: theme.primaryFontColor}">Details</h4>
    ...
    <ion-col size="6">
      <div :class="{ 'amountApproval-input': true, 'invalid-input': invalidAmount }">
        <ion-input v-model="approvalAmount" placeholder="Enter amount" @ionChange="updateTotalLoan()"></ion-input>
      </div>
    </ion-col>
  </ion-row>
                            ...
                            <ion-col class="reason-container">
                                <ion-card class="reason-card">
                                    <ion-textarea v-model="reason" placeholder="Enter your reason here..."></ion-textarea>
                                </ion-card>
                            </ion-col>
                        </ion-col>
...
<script>
    import { IonPage, IonHeader, IonContent, IonIcon, IonFooter, IonToolbar, IonTitle, IonButton, IonCard, IonRow, IonCol, IonGrid, IonLabel, toastController, IonTextarea, IonInput } from '@ionic/vue';
    ...
    methods: {
        ...
        async fetchValeDetails() {
            try {
                ...
                const api =
                baseURL + `api/v2/ess/apply/vale-details`;
        ...
        updateTotalLoan() {
            // Assuming you want to add approvalAmount to previousBalance
            ...
            if (!isNaN(approvalAmount) && approvalAmount > 0) {
                ...
                this.invalidAmount = false; // Reset invalidAmount if it was previously set
            } else {
                // Set totalLoan to previousBalance
