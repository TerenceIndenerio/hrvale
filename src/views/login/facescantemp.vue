<template>
  <ion-page>
    ...
    >
      ...
      <!-- Registration Modal -->
      <ion-modal :is-open="isRegisterModalOpen" @didDismiss="isRegisterModalOpen = false">
        <ion-header>
          <ion-toolbar>
            <ion-title>Register Credentials</ion-title>
            <ion-buttons slot="end">
              <ion-button @click="isRegisterModalOpen = false">Close</ion-button>
            </ion-buttons>
          </ion-toolbar>
        </ion-header>
        <ion-content class="ion-padding">
          ...
          <ion-button expand="block" @click="submitRegistration" class="ion-margin-top">
            Submit
          </ion-button>
        </ion-content>
      </ion-modal>
...
export default defineComponent({
  ...
  methods: {
    ...
    async closeAuthenticated() {
      ...
      this.processing = false;
      this.processFrames();
      this.router.push("/facescantemp");
      console.log("Close authenticated, restart scanning");
      await TextToSpeech.speak({
        text: "Bye and Thank you " + this.scannedUsername,
        lang: "en-US",
        rate: 1.0,
      });
    },
