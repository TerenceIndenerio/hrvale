    ...
    <ion-header>
      <ion-toolbar>
        <ion-buttons slot="start">
          <ion-back-button default-href="/facescantemp"></ion-back-button>
        </ion-buttons>
    ...
    <ion-content :fullscreen="true">
      <ion-grid>
        <ion-row>
          ...
          <ion-col size="2">
            <ion-text><strong>Client ID</strong></ion-text>
          </ion-col>
          <ion-col size="3">
        ...
        <ion-row v-for="face in storedFaces" :key="face.id">
          ...
          <ion-col size="2">
            <ion-text>{{ face.clientID }}</ion-text>
          </ion-col>
          <ion-col size="3">
...
export default defineComponent({
  ...
  methods: {
    ...
    addFace() {
      this.router.push("/facescantemp?mode=register");
    },
    updateFace(face) {
